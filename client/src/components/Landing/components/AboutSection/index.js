...
const AboutSection = () => (
  <div className={styles.AboutSection} id="AboutSection">
    ...
    <div className={styles.TabSection} id="GrowersSection">
      <Selector />
      <div
        className={styles.GrowsersDetails}
        style={{ backgroundImage: `url(${growersBgSrc})` }}
      >
        <div className={styles.GrowsersDetailsContainer + " container"}>
          <h4>CanWe Growers, INC</h4>
          <div className={styles.GrowersDescription}>
            Canwe Growers Inc. (Canwe) has submitted an application to become a
            Licensed Producer (LP) with the Access to Cannabis for Medical
            Purposes Regulations (ACMPR) with a planned production facility in
            Grand Valley, Ontario.
          </div>
          <div className={styles.GrowersContact}>
            For more information please contact us at{" "}
            <a href="mailto:inquiry@canwe.ca?subject=Canwe%Growers">
              inquiry@canwe.ca
            </a>
            <Link to="/contact-us">
              <Button color="#4B4737" backgroundColor="white">
                Contact Us
              </Button>
            </Link>
          </div>
