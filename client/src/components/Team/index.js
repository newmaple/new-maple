...
const TeamItem = ({title, subtitle, body, image}) => (
  <div className={styles.TeamItem}>
    <div className={styles.TeamItemImage} style={{backgroundImage: `url(${image})`}} />
...
const Growers = () => (
  <div className="container">
    ...
    <TeamItem title="Nadeem Khakwani" subtitle="Cultivation and Cloning Lead" body="Nadeem is a trained ISO 9001 specialist and was security-cleared as a Responsible Person in Charge at one of Canada’s leading licensed producers. Among his past accomplishments, Nadeem was a flower-room lead who oversaw over twenty employees, 17,000 cannabis plants, and 5,000 cannabis clones at a time. "/>
    <TeamItem title="Craig Coverley" subtitle="Production Floor Lead" body="As former head grower at one of Canada’s first and leading Licensed Producers, Craig was instrumental in the management of the cultivation process, achieving a remarkable yield of 0.16 lb per sq. ft.With his valuable hands-on experience and extensive knowledge, Craig is widely regarded as a leader in cannabis growing methodologies."/>
    <TeamItem title="Leo Sivak" subtitle="Processing and Oil Extraction" body="Leo is a veteran of the Canadian cannabis industry and an expert in producing plant derivatives and oil extracts. Over the years, he has consulted for numerous cannabis companies and worked to develop an industry-leading CBD oil at one of Canada’s first licensed producers"/>
    <TeamItem title="Joe Yu" subtitle="Mother Room Lead" body="From flower cultivation to plant cloning, Joe has trained personnel in various roles along the cannabis production process. In a true demonstration of his skill and composure, Joe held the critical position of mother room lead at one of Canada’s most reputable licensed producers where he directly oversaw and maintained the health of hundreds of mother plants. "/>
