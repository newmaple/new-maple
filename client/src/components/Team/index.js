...
const Selector = () => (
  <div className={styles.Selector + " container"}>
    <NavLink strict activeClassName={styles.SelectorActive} to="/team">MANAGMENT TEAM</NavLink>
    <NavLink strict activeClassName={styles.SelectorActive} to="/team/growers">CANNABIS DREAM TEAM</NavLink>
  </div>
);
